package com.simProject.planner.views
{
	...
	/**
	 * Провайдер данных для компонента AssemblyList 
	 * @author Глеб
	 */
	public final class AssemblyDataProvider implements IList
	{
		/** Список продуктов. */
		private var _data:Vector.<Assembly> = null;
		
		public function AssemblyDataProvider(data:Vector.<Assembly>)
		{
			_data = data;
		}
		...
		{
			var temp:Assembly = item as Assembly;
			if (!temp) return;
			_data.push(temp);
		}
