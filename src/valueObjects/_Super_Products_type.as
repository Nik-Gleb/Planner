 ...
 * of this value object you may modify the generated sub-class of this class - Products_type.as.
 */
...
[ExcludeClass]
public class _Super_Products_type extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        Planner.Product.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _Products_typeEntityMetadata;
    ...
    model_internal var _internal_product_leaf:Planner.Product;
    ...
    public function _Super_Products_type()
    {
        _model = new _Products_typeEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Products_typeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Products_typeEntityMetadata) : void
    {
        var oldValue : _Products_typeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
